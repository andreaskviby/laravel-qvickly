 ...
 * @method static QvicklyResponse creditPayment(int|string $number, array|\Illuminate\Contracts\Support\Arrayable $lines = [], bool $partial = false)
 * @method static QvicklyResponse creditFull(int|string $number)
 * @method static QvicklyResponse creditPartial(int|string $number, array|\Illuminate\Contracts\Support\Arrayable $lines)
